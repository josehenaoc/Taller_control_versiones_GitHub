//-----------------------------------------------------------------Defini funciones---------------------------------------------------------------------------------------------------------------------------------------------------------------!
SubProceso resultados(nombre_completo, indice_masa_corporal,kilogramo,estatura,resultado)
...
//--------------------------------------------------------------Ejecucíon del código--------------------------------------------------------------------------------------------------------------------------------------------------------------!
	...
	resultados(nombre_completo,indice_masa_corporal,kilogramo,estatura,resultado);
