//-----------------------------------------------------------------------------Definir Funciones---------------------------------------------------------------------------------------------------------------------!
SubProceso cilindrajes(nombre_completo,direccion,numero_telefonico,correo_electronico,novedades,marca_modelo,cilindraje)
...
//---------------------------------------------------------------------------Ejecucion del código-------------------------------------------------------------------------------------------------------------------!
	...
	cilindrajes(nombre_completo,direccion,numero_telefonico,correo_electronico,novedades,marca_modelo,cilindraje);
