...
//-----------------------------------------------------------------------------Definir Variables---------------------------------------------------------------------------------------------------------------------!
	Definir nombre_completo, direccion, numero_telefonico, correo_electronico, torta_eleccion, torta1_disponible, torta2_disponible, torta3_disponible, decoracion Como Caracter;
	Definir menu1, menu2, pedido, porciones Como Entero;
