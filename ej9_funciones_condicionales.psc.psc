//-----------------------------------------------------------------------------Definir funciones-----------------------------------------------------------------------1
SubProceso menu(nombre_completo, menu_area)
	
	Definir area_rectangulo, area_triangulo, area_trapecio, base, altura, base_altura, base_mayor, base_menor, menu_areas, menu_opciones Como Entero;
...
Proceso ejercicio9_condicionales
	...
	menu(nombre_completo, menu_area);
