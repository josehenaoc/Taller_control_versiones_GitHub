...
//------------------------------------------------------------------------------Definir variables-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------1
    ...
    Definir nombre_completo, desicion, edad, numero_celular, correo_electronico,usuario1,usuario2,usuario3,usuario4,usuario5,usuario6, usuario7, usuario8, calificacion2, calificacion3, calificacion4, calificacion5, calificacion6, calificacion7, curso_carro, curso_moto Como Caracter;
	Definir menu, nota,nota1,nota2,nota3,nota4,nota5,nota6,nota7,nota8 Como Real;
